...
const WAYPOINTS: Waypoint[] = [
  {
    ...
    coordinates: [77.679, 13.413], // placeholder — replace with real coords
    mediaType: "image",
    mediaUrl:
...
// Injected once into <head> — Mapbox markers/popups/controls live outside
...
export default function TrekRoute3DCanvas() {
  ...
  function flyToWaypoint(point: Waypoint, bearing: number) {
    ...
    new mapboxgl.Popup({ offset: 25, closeButton: true, className: "route3d-popup" })
  ...
  useEffect(() => {
    ...
    // ===== EDIT ME: your Mapbox access token =====
    // Set NEXT_PUBLIC_MAPBOX_TOKEN in .env.local (dev) and in Vercel's
    // project environment variables (production). Get a free token at
